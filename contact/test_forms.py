...
class TestFeedbackForm(TestCase):
    def test_form_name_invalid(self):
        ...
        self.assertFalse(
            ...
            msg='Post form is valid despite missing name'
        )
    ...
    def test_form_email_missing(self):
        ...
        self.assertFalse(
            feedback_form.is_valid(),
            msg='Post form is valid despite missing email'
        )
    ...
    def test_form_email_invalid(self):
        ...
        self.assertFalse(
            feedback_form.is_valid(),
            msg='Post form is valid despite invalid email format'
        )
    ...
    def test_form_message_invalid(self):
        ...
        self.assertFalse(
            feedback_form.is_valid(),
            msg='Post form is valid despite missing message'
        )
    ...
    def test_form_is_incorrectly_invalid(self):
        ...
        self.assertTrue(
            feedback_form.is_valid(),
            msg='Post form is invalid and should not be'
        )
